...
class Sonde:
    ...
    def extrapolate_na_sondes(self, max_alt=300):
        ds = self.interim_l3_ds.reset_coords().drop_attrs(deep=False)
        ...
        ds[self.alt_dim].attrs = self.interim_l3_ds[self.alt_dim].attrs
        ds = ds.assign_attrs(self.interim_l3_ds.attrs)

        self.interim_l3_ds = xr.merge(
            [ds, self.interim_l3_ds],
            join="exact",
            compat="override",
